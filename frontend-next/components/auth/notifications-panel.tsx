...
function scheduleRangeBadge(item: ReportScheduleItem) {
  ...
  if (item.reportKey === 'plantillas.cartera_bloques') {
    return {
      label: 'Rango dinamico mensual',
      className: 'border-cyan-200 bg-cyan-50 text-cyan-700',
    };
  ...
  if (item.reportKey === 'plantillas.ventas_compras_bloques') {
    return {
      label: 'Rango dinamico mensual',
      className: 'border-cyan-200 bg-cyan-50 text-cyan-700',
    };
...
function supportsDynamicRangeForSchedule(item: ReportScheduleItem | null) {
  ...
  return item.reportKey === 'finanzas.balance_general'
    ...
    || item.reportKey === 'plantillas.cartera_bloques'
    || item.reportKey === 'plantillas.ventas_compras_bloques';
}
