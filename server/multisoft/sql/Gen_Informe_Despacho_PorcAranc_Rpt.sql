ALTER PROCEDURE "DBA"."Gen_Informe_Despacho_PorcAranc_Rpt"( in mSession_ID char(16),in mCod_Empresa char(2),in mPeriodo char(8),in mAnho numeric(4),in mCodDespachante char(4),in mNroDespacho numeric(7),in mCierre char(1),in mTipo char(1) ) 
//A = Asiento - C = Costeo
begin
